...
export const ConversationsDashboard = ({
  ...
  const addMetadataToConversation = (conversation: Conversation | null) => {
    ...
    const newMetadata = {
      ...
      'Paying Member': tempData !== undefined ? tempData[8] : '',
      'Signup Date': tempData !== undefined ? tempData[9] : '',
      'Subscriber Type': tempData !== undefined ? tempData[10] : '',
      'Subscriber Price': tempData !== undefined ? tempData[11] : '',
      'Device Platform': tempData !== undefined ? tempData[12] : '',
      Country: tempData !== undefined ? tempData[13] : '',
      City: tempData !== undefined ? tempData[14] : '',
      'Time Spent in Minutes': tempData !== undefined ? tempData[15] : '',
      'Open App Count': tempData !== undefined ? tempData[16] : '',
      'Compliance Average': tempData !== undefined ? tempData[17] : '',
      'Flexion Average': tempData !== undefined ? tempData[18] : '',
      'Extension Average': tempData !== undefined ? tempData[19] : '',
      'Days of Exercise': tempData !== undefined ? tempData[20] : '',
